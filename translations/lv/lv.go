...
import (
	...
	ut "github.com/zhangdapeng520/zdpgo_validator/universal-translator"
)

// RegisterDefaultTranslations registers a set of default translations
// for all built in tag's in validator; you may add your own as desired.
func RegisterDefaultTranslations(v *zdpgo_validator.Validate, trans ut.Translator) (err error) {
	translations := []struct {
		tag             string
		translation     string
		override        bool
		customRegisFunc zdpgo_validator.RegisterTranslationsFunc
		customTransFunc zdpgo_validator.TranslationFunc
	}{
		{
			tag:         "required",
		...
		},
		{
			...
			customTransFunc: func(ut ut.Translator, fe zdpgo_validator.FieldError) string {
				var err error
				var t string
