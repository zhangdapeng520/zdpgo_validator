...
<p align="center">
  <a href="https://pkg.go.dev/github.com/zhangdapeng520/zdpgo_validator/mimetype">
    <img alt="Go Reference" src="https://pkg.go.dev/badge/github.com/zhangdapeng520/zdpgo_validator/mimetype.svg">
  </a>
  <a href="https://goreportcard.com/report/github.com/zhangdapeng520/zdpgo_validator/mimetype">
    <img alt="Go report card" src="https://goreportcard.com/badge/github.com/zhangdapeng520/zdpgo_validator/mimetype">
  </a>
...
- possibility to [extend](https://pkg.go.dev/github.com/zhangdapeng520/zdpgo_validator/mimetype#example-package-Extend) with other file formats
- common file formats are prioritized
- [text vs. binary files differentiation](https://pkg.go.dev/github.com/zhangdapeng520/zdpgo_validator/mimetype#example-package-TextVsBinary)
- safe for concurrent usage

## Install
```bash
go get github.com/zhangdapeng520/zdpgo_validator/mimetype
```
...
```
See the [runnable Go Playground examples](https://pkg.go.dev/github.com/zhangdapeng520/zdpgo_validator/mimetype#pkg-overview).
...
[open an issue](https://github.com/zhangdapeng520/zdpgo_validator/mimetype/issues/new?assignees=&labels=&template=mismatched-mime-type-detected.md&title=).
...
[reader](https://pkg.go.dev/github.com/zhangdapeng520/zdpgo_validator/mimetype#DetectReader)
or from a [file](https://pkg.go.dev/github.com/zhangdapeng520/zdpgo_validator/mimetype#DetectFile)
**mimetype** limits itself to reading only the header of the input.
<div align="center">
  <img alt="structure" src="https://github.com/zhangdapeng520/zdpgo_validator/mimetype/blob/420a05228c6a6efbb6e6f080168a25663414ff36/mimetype.gif?raw=true" width="88%">
</div>
