...
func (pt *pt_LU) Decimal() string {
	return pt.decimal
}

// Group returns the group of number
func (pt *pt_LU) Group() string {
	return pt.group
}

// Group returns the minus sign of number
func (pt *pt_LU) Minus() string {
	return pt.minus
}
