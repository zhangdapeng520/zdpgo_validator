...
func (zh *zh_Hans_MO) Decimal() string {
	return zh.decimal
}

// Group returns the group of number
func (zh *zh_Hans_MO) Group() string {
	return zh.group
}

// Group returns the minus sign of number
func (zh *zh_Hans_MO) Minus() string {
	return zh.minus
}
