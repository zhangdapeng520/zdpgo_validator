...
func (en *en_MW) Decimal() string {
	return en.decimal
}

// Group returns the group of number
func (en *en_MW) Group() string {
	return en.group
}

// Group returns the minus sign of number
func (en *en_MW) Minus() string {
	return en.minus
}
