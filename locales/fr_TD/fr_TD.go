...
func (fr *fr_TD) Decimal() string {
	return fr.decimal
}

// Group returns the group of number
func (fr *fr_TD) Group() string {
	return fr.group
}

// Group returns the minus sign of number
func (fr *fr_TD) Minus() string {
	return fr.minus
}
