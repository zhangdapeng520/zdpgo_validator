...
func (en *en_AU) Decimal() string {
	return en.decimal
}

// Group returns the group of number
func (en *en_AU) Group() string {
	return en.group
}

// Group returns the minus sign of number
func (en *en_AU) Minus() string {
	return en.minus
}
