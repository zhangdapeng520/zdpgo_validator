...
func (ta *ta_LK) Decimal() string {
	return ta.decimal
}

// Group returns the group of number
func (ta *ta_LK) Group() string {
	return ta.group
}

// Group returns the minus sign of number
func (ta *ta_LK) Minus() string {
	return ta.minus
}
